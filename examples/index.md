...
This section contains complete, end-to-end examples of how to use the AAStar SDK for various roles and use cases.
...
Most examples can be run against a local Anvil instance. Ensure you have the [AAStar Contracts](https://github.com/AAStarCommunity/SuperPaymaster) deployed locally first.
