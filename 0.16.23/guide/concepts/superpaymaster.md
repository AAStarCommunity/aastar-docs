...
- [Operator API](/0.16.23/api/roles/operator) - Become an operator
- [Community API](/0.16.23/api/roles/community) - Set up gas sponsorship
- [End User API](/0.16.23/api/roles/enduser) - Use gasless transactions

## Next Steps

- [EOA Rainbow Bridge](/0.16.23/guide/concepts/rainbow-bridge)
- [Reputation System](/0.16.23/guide/concepts/reputation)
- [Quick Start](/0.16.23/guide/quick-start)
